...
const MemoStack: React.FC = () => {
  ...
  return (
    <div className=" pb-16 px-7">
      ...
      <p className="text-center pb-10 text-2xl">Find pairs of matching cards</p>

      <div className="border-2 rounded-lg  shadow-lg shadow-neutral-500    dark:border-neutral-700 dark:bg-neutral-800  p-2 ">
        <ul className="grid lg:grid-cols-7  xs:grid-cols-4 gap-3">
          {memoStack.map((el: string) => {
            ...
            return (
              <li
                ...
                key={el}
                className="border-[0.5px] border-neutral-500 p-1 cursor-pointer hover:shadow-lg hover:shadow-fuchsia-700 hover:bg-neutral-300  dark:hover:bg-neutral-600  rounded-md"
              >
